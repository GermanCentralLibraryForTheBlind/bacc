...
const CHECKER_CHROMIUM = './node_modules/ace-core/packages/ace-core/lib/checker/checker-chromium.js';
const temp = [];
var validateInject = 0;


searchReplaceFile('puppeteer.launch({ args });', 'puppeteer.launch({ args, devtools: true,  slowMo: 250 });', CHECKER_CHROMIUM);
...
function searchReplaceFile(search, replace, file) {
